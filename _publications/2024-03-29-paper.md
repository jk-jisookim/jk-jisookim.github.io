...
{{ post.content | split: site.excerpt_separator | first }} <a class="read-more" href="{{ paperurl }}{{ post.url }}">Read more...</a></p>

{% if post.excerpt != post.content %}
    <a href="{{ https://www.nature.com/articles/s41558-024-01980-w }}{{ post.url }}">Read more</a>
{% endif %}
