...
{{ post.content | split: site.excerpt_separator | first }} <a class="read-more" href="{{ paperurl }}{{ paperurl }}">Read more...</a>

{% if post.excerpt != post.content %}
    <a href="{{ https://www.nature.com/articles/s41558-024-01980-w }}{{ https://www.nature.com/articles/s41558-024-01980-w }}">Read more</a>
{% endif %}
